<template >
  ...
  <div class="flex flex-row justify-center items-center bg-gray-300 p-4 rounded-md">  <label class="text-black text-4xl font-bold">Frequently Asked Questions</label></div>
...
//   },
  ...
  methods:{
    insertArticle(){
        ...
        axios.post(vm.globalUrl + "createBlog", data).then((result)=>{
            if(result.data == true){
                vm.content = ''
                vm.headline = ''
            }else{
