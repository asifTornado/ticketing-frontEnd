<template>
  <div class="flex flex-col">
    <div class="flex flex-row justify-start items-center font-bold text-black text-lg">Average Acceptance Time</div>
    ...
    <div class="flex flex-row p-3 justify-start items-start noprint" id="top">
      ...
      <span class=" text-black font-bold text-md  mr-2">Duration</span>
          ...
          <option :value="JSON.stringify({duration:86400, name:'Last 24 Hours'})" >Last 24 Hours</option>
