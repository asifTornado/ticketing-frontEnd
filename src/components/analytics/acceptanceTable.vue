<template>
 ...
 <div class="flex flex-row justify-between items-center">
        <label class="mr-5">Time In</label>
                <button class="mr-5 bg-slate-300 p-2 rounded-md" @click="filterDate(event, minutes, 'Mean Time To Acceptance In Minutes', 'dodgerblue', 'minutes')">Minutes</button>
                <button class="mr-5 bg-slate-300 p-2 rounded-md" @click="filterDate(event, hours, 'Mean Time To Acceptance In hours', 'lime', 'hours')">Hours</button>
                <button class="mr-5 bg-slate-300 p-2 rounded-md" @click="filterDate(event, days, 'Mean Time To Acceptance In Days', 'red', 'days')">Days</button>
...
methods:{
    ...
    {
      label: 'Mean Time To Acceptance In Minutes',
