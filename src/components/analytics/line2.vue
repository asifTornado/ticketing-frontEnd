<template>
     ...
     <div style="height:200px; width:600px" class="pb-5 flex text-center  flex-row justify-center items-center"><Line :data="{labels, datasets}" :options="options" :plugins="['zoomPlugin']" /></div>
