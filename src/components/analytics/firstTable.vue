<template>
    <div class="flex flex-col">
      <div class="flex flex-row justify-start items-center font-bold text-black text-lg">Average time for first response</div>
...
export default {
  ...
  }else if(userType == "departmentPower"  || userType == "leader" || user.userType == "Ticket Manager (Department)"){
